...
// Checking if nodes have disconected or joined the network.
       int number_of_nodes = esp_mesh_get_total_node_num(), max_layer = esp_mesh_get_layer(), routing_table_size = esp_mesh_get_routing_table_size(); 
     // printf("Number of Nodes = %d And the max layer = %d  The routing table size is = %d \n", number_of_nodes, max_layer, routing_table_size); 
